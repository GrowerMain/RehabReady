...
import static com.example.rehabready.Fragments.MedicationScheduleFragment.DAY_IN_CURRENT_WEEK;
import static com.example.rehabready.Fragments.MedicationScheduleFragment.DAY_NUMBER;
import static com.example.rehabready.Fragments.MedicationScheduleFragment.DAY_OF_WEEK;
import static com.example.rehabready.Fragments.MedicationScheduleFragment.MEDICATIONS;
import static com.example.rehabready.Helpers.DBHelper.DARK;
import static com.example.rehabready.Helpers.DBHelper.LIGHT;
import static com.example.rehabready.Helpers.DBHelper.THEME;
...
import com.example.rehabready.Fragments.MedicationScheduleFragment;
...
import com.example.rehabready.Views.StandardCardView;
import com.google.android.material.bottomnavigation.BottomNavigationView;

public class activity_medication extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bottomNav.setOnNavigationItemSelectedListener(item -> {
            ...
            if (itemId == R.id.navigation_home) {
                startActivity(new Intent(activity_medication.this, MainActivity.class));
                return true;
            } else if (itemId == R.id.navigation_journal) {
                startActivity(new Intent(activity_medication.this, calendar.class));
                return true;
            } else if (itemId == R.id.navigation_med) {
                startActivity(new Intent(activity_medication.this, activity_medication.class));
                return true;
            }
        ...
        if (actionBar != null) {
            actionBar.setTitle(getString(R.string.med_schedule));
        } else {
            // Handle the case where getSupportActionBar() returns null
            // For example, you might want to log a message or take alternative actions.
        }
